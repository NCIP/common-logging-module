...
public class MessageGenerator
{
	 ...
	 */
	public static String generateStringMessage(Object obj, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames, Type[] types, String operation)
	{
		String message = null;
		if (operation.equalsIgnoreCase("update"))
		{
			...
			try
			{
				...
				messagePreviousState.append("&operation=[name=" + operation.toUpperCase() + "]&object=[name=" + obj.getClass().getName() + "]");
				if (previousState != null)
				{
					messagePreviousState.append("&previousAttributes=[");
				}
				...
				for (int index = 0; index < currentState.length; index++)
				{
					if (index == 0)
					{
						if (previousState != null)
						{
							messagePreviousState.append(String.valueOf(propertyNames[index]) + "=" + String.valueOf(previousState[index]));
						}
						else
						{
						...
						{
							messageCurrentState.append(String.valueOf(propertyNames[index]) + "=" + String.valueOf(currentState[index]));
						}
						else
						{
			...
			if (previousState != null)
			{
				messagePreviousState.append("]&currentAttributes=[");
			}
			else
				messagePreviousState.append("&currentAttributes=[");
		...
		else
		{
			...
			try
			{
				...
				messageState.append("&operation=[name=" + operation.toUpperCase() + "]&object=[name=" + obj.getClass().getName() + "]");
				...
				for (int index = 0; index < currentState.length; index++)
				{
					if (index == 0)
					{
						if (currentState != null)
						{
							messageState.append(String.valueOf(propertyNames[index]) + "=" + String.valueOf(currentState[index]));
						}
						else
						{
	 ...
	 * @throws IOException
	 */
	public static void convert(String entityName, Serializable id, Object[] State, String[] propertyNames, Type[] types, String operation, OutputStream out) throws IOException
	{
	...
	public static void generateXMLMessage(Object obj, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames, Type[] types, String operation, String outfileName)
	{
		...
		try
		{
			...
			if (operation.equalsIgnoreCase("update"))
			{
				convert(entityName, id, currentState, previousState, propertyNames, types, operation, out);
			}
			else
				convert(entityName, id, currentState, propertyNames, types, operation, out);
		}
		catch (IOException e)
		{
	 ...
	 * @throws IOException
	 */
	public static void convert(String entityName, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames, Type[] types, String operation, OutputStream out) throws IOException
	{
