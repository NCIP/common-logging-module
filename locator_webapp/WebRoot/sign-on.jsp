            ...
            <TABLE cellSpacing=2 cellPadding=2 width=450 align=center
              ...
              <TR>
               ...
               <TR>
		                <TD>
		                  <DIV align=right> 
                        <P class=normalBold><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><bean:message key="signin.application"/></font></strong></P>
                      </DIV></TD>
		                <td  class="displayValue" maxlength="20" size="18">         
          <html:select property="application" ><custom:applications />              	
         </html:select>
