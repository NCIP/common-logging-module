	...
	<tr><td class="formLabelyellow">User: <%= (String) request.getSession().getAttribute("USERNAME") %></td>
        ...
        <tr>
          ...
          <td  class="formLabelwhite">
              Application:
          </td> <td class="displayValue">
           <html:text property="application"  value ="<%= (String) request.getSession().getAttribute("APPLICATION") %>"  maxlength="100" size="8" readonly="true"/>          
           </td>
        </tr>
        <!-- 
        <tr>
          ...
          <html:select property="application">
              	<html:option value="<%= (String) request.getSession().getAttribute("APPLICATION") %>"><%= (String) request.getSession().getAttribute("APPLICATION") %></html:option>              	
            </html:select>
        ...
        <tr>
         ...
         <tr>
          <td valign="middle" colspan="2">
            <html:text property="user" maxlength="200" size="18"/>
          </td>
         </tr>
         ...
         <tr>
          <td valign="middle" colspan="2">
            <html:text property="sessionid" maxlength="200" size="18"/>
          </td>
         </tr>
