...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="2">
         ...
         <!-- Server Field -->
          ...
          <tr>
               	<!-- Thread Field -->
               <td width="36" valign="top" class="stestBlue"><bean:message key='field.thread'/></td>
              <td width="130" valign="top" class="stestBlack">
         ...
         <!--User Field -->
		     <td width="36" valign="top" class="stestBlue"><bean:message key='field.user'/></td>
            <td width="130" valign="top" class="stestBlack">
                <bean:write name="next" property="user" filter="false" />
           </td>
          <!-- Session ID Field -->
                <td width="70" valign="top" class="stestBlue"><bean:message key='field.sessionid'/></td>
               <td width="130" valign="top" class="stestBlack">
                 <bean:write name="next" property="sessionid" filter="false" />
               </td>
         </tr>     
