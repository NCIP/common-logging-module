			...
			<table summary="" cellpadding="0" cellspacing="0" border="0"
				...
				<tr>
					...
					<table summary="" cellpadding="0" cellspacing="0" border="0"
						...
						<tr>
							<td class="welcomeContent" valign="top">Lorem ipsum dolor sit
								...
								<tr>
									...
									<table cellpadding="2" cellspacing="0" border="0">
										<tr>
											...
											ID</label></td>
											<td class="formFieldLogin"><input class="formField"
												type="text" name="loginID" size="14" /></td>
										</tr>
										<tr>
											<td class="sidebarLogin" align="right"><label for="password">PASSWORD</label></td>
											<td class="formFieldLogin"><input class="formField"
												type="password" name="password" size="14" /></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
